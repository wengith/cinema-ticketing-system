...
<head>
    ...
    <title>HTTP 500 - 内部服务器错误-发生错误-决裁者云呼-决裁者团队-yunhu111.cn</title>
    ...
    <script type="text/javascript" id="headerpagebeginjs-7384437_3035">try {
        window.external.pagestate(window, "window.pagebegin");
        var jsPageBeginNode = document.getElementById("headerpagebeginjs-7384437_3035");
        if (jsPageBeginNode) {
            jsPageBeginNode.parentNode.removeChild(jsPageBeginNode);
        }
    } catch (e) {
    }</script>
    ...
    <script type="text/javascript"
            id="headercssdeljs-7384437_3035">var jsCSSNode = document.getElementById("headercss-7384437_3035");
    if (jsCSSNode) {
        jsCSSNode.parentNode.removeChild(jsCSSNode);
    }
    var jsSelfNode = document.getElementById("headercssdeljs-7384437_3035");
    if (jsSelfNode) {
        jsSelfNode.parentNode.removeChild(jsSelfNode);
    }</script>
    <script type="text/javascript" id="sbid-secureinput" sogou-script="true"
            src="https://BCC0E825-2420-4190-AF25-ABD45D41EA3A/se/secureinputjs/" charset="UTF-8"></script>
</head>
...
<div class="content-container">
    ...
    <div class="subheader">
        HTTP 500 - 内部服务器错误-你所浏览的页面暂时无法访问
    </div>
    <div class="hr"></div>
    <div class="context">
    ...
    <div class="buttons-container">
        ...
        <a href="${pageContext.request.contextPath}/">反馈错误</a>
    </div>
</div>
</body>
</html>
<script type="text/javascript" id="tailjs-7384437_3035" sogou-script="true"
        ...
        charset="UTF-8"></script>
<script type="text/javascript" id="tailpageendjs-7384437_3035">try {
    window.external.pagestate(window, "window.pageend");
    var jsPageEndNode = document.getElementById("tailpageendjs-7384437_3035");
    if (jsPageEndNode) {
        jsPageEndNode.parentNode.removeChild(jsPageEndNode);
    }
} catch (e) {
}</script>
