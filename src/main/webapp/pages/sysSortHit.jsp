...
<div class="layui-body">
    ...
    <div style="padding: 60px;">
        ...
        <a href="${pageContext.request.contextPath}/pages/sysmoviesHit.jsp" class="layui-btn layui-btn-normal">电影点击量</a>
